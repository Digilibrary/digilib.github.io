...
if(isset($_POST['del'])){
	...
	$sql_del = "DELETE from books where BooksId = $id"; 
	$error = false;
...
<div class="container">
	...
	<div class="container">
        ...
        <div class="delete" class="alert alert-success alert-dismissable">
                  <button class="delete-record" type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                  <strong>Record Deleted Successfully!</strong>
            </div>
            <?php } ?>
			  <div class="add" class="row"><br>
		  	  <a href="addbook.php"><button class="add-button" class="btn btn-success col-lg-3 col-md-4 col-sm-11 col-xs-11 button" style="margin-left: 15px;margin-bottom: 5px"><span class="glyphicon glyphicon-plus-sign"></span> Add Book</button></a>
...
if(isset($_POST['search'])){
	...
	<tbody>
		...
		<td><?php echo $row['Status']; ?></td>
		<form method='post' action='bookstable.php'>
		<input type='hidden' value="<?php echo $row['BooksId']; ?>" name='id'>
		<td><button class="delete-button"  name='del' type='submit' value='Delete' class='btn btn-warning' onclick='return Delete()'>DELETE</button></td>
		</form>
		</tbody>
